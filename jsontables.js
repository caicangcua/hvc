            ...
            success: function (data, textStatus, xhr) {
                ...
                if (data == null) {
                    ...
                    if (data['FF_MayCat'] != null && data['FF_MayCat'] != '') {
                        ...
                        //
                        if (data['Lines'] != null) {
                            jsonTable.fromJSON(data['Lines']);
                        }
                    };
                    document.getElementById('head1').innerHTML = headertitle;
        ...
        for (var jr = 0; jr < jsonSourceData.length; jr++) {
            ...
            for (var ki = 0; ki < tableHeaderArray.length; ki++) {
                if (ki == 0) {
                    ...
                    tableDataRow.append('<td>' + "<div class='thoigian'>" + _val[0] + "</div><div class='solieu'>" + _val[1] + "</div>" + '</td>');
                };
            };
